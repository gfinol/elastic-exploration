...
public class TMServerlessUTS {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Parallelism: " + parallelism + ", numberOfIterationsPerWave: " + numberOfIterationsPerWave + ", workers: " + opts.parallelism);
            System.out
            ...
            System.out.println("taskStatsList.size=" + taskStatsList.size());
