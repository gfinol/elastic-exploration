...
import eu.cloudbutton.bc.hybrid.HybridResult;

import java.io.Serializable;
import java.util.concurrent.Callable;

public class HybridCallable implements Callable<HybridResult>, Serializable  {
    ...
    public HybridCallable(int startIndex, int endIndex, RMat rmat, int permute) {
    ...
    @Override
    public HybridResult call() throws Exception {
        ...
        HybridResult result = new HybridResult(betweennessMapLocal, initTs, endTs);
        return result;
    }
}
